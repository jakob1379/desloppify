...
def cmd_plan_output(args: SimpleNamespace) -> None:
...
def _cmd_plan_generate(args: SimpleNamespace) -> None:
...
def _cmd_plan_show(args: SimpleNamespace) -> None:
...
def _cmd_plan_reset(args: SimpleNamespace) -> None:
